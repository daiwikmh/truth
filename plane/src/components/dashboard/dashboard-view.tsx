...
export function DashboardView({
    ...
    return (
      ...
      >
        <div className="border border-foreground/15 rounded-xl px-8 py-10 text-center max-w-sm">
          ...
          <button
            onClick={onNewScan}
            className="text-[10px] font-mono tracking-[0.15em] uppercase border border-foreground/20 rounded-lg px-5 py-2.5 hover:bg-foreground hover:text-background transition-colors cursor-pointer"
          >
            $ scan --project
          </button>
        </div>
  ...
  return (
    ...
    >
      {/* Summary bar */}
      <div className="grid grid-cols-3 border border-foreground/15 rounded-xl overflow-hidden">
